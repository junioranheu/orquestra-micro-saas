        ...
        >
            <div className={styles.wrapper}>
                <span className={styles.content}>
                    ...
                    <span>Todos os direitos reservados © {new Date().getFullYear()} — Desenvolvido por <Tippy content='LinkedIn.'><Link href={SYSTEM.URL_LINKEDIN} target='_blank'>@junioranheu</Link></Tippy>.</span>
                </span>
