...
//                             <Tags
//                                 tags={[
//                                     { label: handleFormatDate(formData.date, DATE_STYLE.DETALHADO) },
//                                     { label: formData.scheduleStatus },
...
//                             <Dropdown title='Membros' options={companyUsersDropDown ?? []} selectedOption={companyUsersDropDown?.filter(x => formData.usersIds?.map(u => u.toString()).includes(x.value.toString())) ?? []} setSelectedOption={setCompanyUsersIdOption} isDisabled={!editing} />
