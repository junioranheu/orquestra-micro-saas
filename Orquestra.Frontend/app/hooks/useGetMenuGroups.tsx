        ...
        const MENU_GROUPS: iMenuGroup[] = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { id: 'acompanhamento', label: 'Acompanhamento', description: 'Acompanhe retornos e contatos com clientes. Follow-up!', icon: 'repeat', route: ROUTES.EMPRESA_ACOMPANHAMENTO, hasAccess: handleCheckShowElement({ me, rolesRequired: [MODULES.CostumerFollowUp] }) },
