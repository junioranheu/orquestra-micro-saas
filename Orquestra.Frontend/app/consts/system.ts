...
const SYSTEM = {
    ...
    COOKIE_AUTH_BACK: 'COOKIE_AUTH_BACK',
    ...
    LOCAL_STORAGE_IS_MODAL_GRID: 'LOCAL_STORAGE_IS_MODAL_GRID',
    LOCAL_STORAGE_SHOW_LOGS_DASHBOARD: 'LOCAL_STORAGE_SHOW_LOGS_DASHBOARD',
    LOCAL_STORAGE_DASHBOARD_ROUTE_SHORTCUT: 'LOCAL_STORAGE_DASHBOARD_ROUTE_SHORTCUT',
